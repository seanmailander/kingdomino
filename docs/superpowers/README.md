...
| [2026-03-26-discard-protocol-design.md](specs/2026-03-26-discard-protocol-design.md) | Fix discard deadlock in flow and peer protocol | design-only |
...
| [2026-03-27-full-game-loop-menu-start-pause-exit-design.md](specs/2026-03-27-full-game-loop-menu-start-pause-exit-design.md) | Complete game loop with menu, start, pause, exit states | planned |
